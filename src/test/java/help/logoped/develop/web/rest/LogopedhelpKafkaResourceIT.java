...
public class LogopedhelpKafkaResourceIT {
    ...
    @Autowired
    private LogopedhelpKafkaProducer producer;

    @Autowired
    private LogopedhelpKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        LogopedhelpKafkaResource kafkaResource = new LogopedhelpKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/logopedhelp-kafka/publish?message=test"))
